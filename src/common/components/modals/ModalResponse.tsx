    ...
    <Modal open={open}>
      <div className="w-[550px] flex flex-col gap-3 p-3 items-center">
        ...
        <div className="flex items-center flex-col">
          <span className="text-[#2D2A2A] text-[30px] font-bold">Maintenance Calling</span>
          <span className="text-[#514E4E] text-[20px]">{"Line B"} | {'12:58:00'}</span>
          <span className="text-[#DE1B1B] text-[22px] font-semibold">Remark : Machine rusak tiba-tiba</span>
        </div>
