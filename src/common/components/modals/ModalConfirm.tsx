    ...
    <Modal open={open}>
      <div className="w-[550px] flex flex-col gap-3 p-3 items-center">
        ...
        <div className="flex items-center flex-col">
          <span className="text-[#2D2A2A] text-[30px] font-bold">Confirm Maintenance Calling?</span>
          <span className="text-[#514E4E]">{"Line B"} | {time}</span>
        </div>

          <form onSubmit={onSave} className="w-full">
            <div className="flex flex-col gap-3 pb-8">
              <label htmlFor="remark" className="text-[#DE1B1B] font-bold text-xl">Remark</label>
              <input type="text" className="p-3 w-full border" placeholder="Input remark"/>
            </div>
