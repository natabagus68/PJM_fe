...
export default function LoginCalled() {
    ...
    return (
      <main className="w-screen h-[100dvh] flex border-4 border-white bg-[#212121]">
        <div className="flex-1 flex items-center justify-center">
          <form
            className="w-[500px] h-[650px] bg-transparent rounded-sm border-[5px] border-[#F0F1F3]  px-[72px] py-[20px] flex flex-col justify-between"
            ...
            <div className="flex flex-col gap-[25px]">
              ...
              >
                ...
                <input
                  ...
                  onChange={login.handleFormInput}
              ...
              >
                ...
                <select
                  defaultValue={""}
                  className="w-full bg-transparent py-2 focus:outline-none active:border-none text-[#B8B6B6]"
                  name="lineId"
                  id=""
                  value={login.form.lineId}
                  onChange={login.handleFormInput}
                >
              ...
              >
                ...
                <select
                  defaultValue={""}
                  className="w-full bg-transparent py-2 focus:outline-none text-[#B8B6B6] "
                  name="shift"
                  id=""
                  value={login.form.shift}
                  onChange={login.handleFormInput}
                >
                  <option value="" disabled>
                    Select shift
                  </option>
                  {login.shift.map((item) => {
                    return <option value={item.id}>{item.name}</option>;
                  })}
                </select>
              </div>
