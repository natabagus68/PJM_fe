            ...
            <table className="w-full">
              ...
              <tbody>
                {user.users?.map((item) => (
                  <tr
                    key={item?.id}
                    className="border-b h-[64px] border-[#D0D3D9] bg-[#FFFFFF] font-[400] text-[16px] relative"
                  >
                    ...
                    <td className="px-4 flex gap-3 my-2">
                      {item?.role === "SUPER_ADMIN" ? (
                        <>
                          <span
                            className="rounded text-sm flex items-center gap-2 cursor-pointer justify-center w-[96px] h-[46px] bg-[#1BBDD4] text-[#FFFFFF]"
                          ...
                          <span
                            className="rounded text-sm flex items-center gap-2 cursor-pointer justify-center w-[96px] h-[46px] bg-[#F79009] text-[#FFFFFF]"
