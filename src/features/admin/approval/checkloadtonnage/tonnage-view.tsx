...
import TonnageTable from "./tabel/table-view";
import TonnageChart from "@features/admin/approval/checkloadtonnage/chart/chart-view";
    ...
    <>
      <div className="flex justify-end gap-3 my-4 mx-6">
        ...
        <div className="flex gap-2 items-center">
          <span
            className={`${tonnage.view ? "text-[#19ACC1]" : "text-[#B8B6B6]"}`}
          >
            Table
          </span>
          <Switch
          ...
          <span
            className={`${!tonnage.view ? "text-[#12B569]" : "text-[#B8B6B6]"}`}
          >
            Chart
          </span>
        </div>
      ...
      {!!tonnage.view ? (
        <TonnageTable data={tonnage.data} />
      ) : (
        <TonnageChart data={tonnage.data} />
      )}
    </>
  );
}
